...
const CheckXor = (args) => {
    ...
    {
        data = '{"code":300, "text":["XOR arg1 arg2", "Bitwise XOR operator. If only one of the bits from arg1 and arg2 is 1, the result is 1; otherwise, it is 0"]}';
    }
    ...
    {
        data = `{"code":200, "text":["Command successful", "Used XOR on ${args[1]} with ${args[2]} and saved to ${args[1]}"], "change":["${args[1]}","${args[2]}"]}`;
    }
